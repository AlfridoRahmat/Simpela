          ...
          <div class="row mb-1">
            <div class="col-auto">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Edit Data Penyaluran</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              <h3 class="card-title"> Ubah Data Penyaluran</h3>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" id="kecamatan" name="ish" onchange="getKec(this.value);">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Tahun</label>
                    <select class="form-control select2" style="width: 100%;" name="tahun" id="year" onchange="getYear(this.value);">
                  ...
                  <div class="form-group">
                    <label> Bulan </label>
                    <select class="form-control select2" style="width: 100%;" name="bulan" id="month" onchange="getMonth(this.value);">
...
if (isset($_POST['tombol'])) {
    include_once "koneksi.php"; 
     ...
     $total_og = $_POST['og'];
      ...
      $query="UPDATE tb_pupuk SET pupuk_urea=$total_urea,
      pupuk_sp=$total_sp,pupuk_za=$total_za,
      pupuk_npk=$total_npk,pupuk_fk=$total_fk,
      pupuk_og=$total_og WHERE id_pupuk=$id_dist";
   ...
   var bulan = document.getElementById("month");
   var kec = document.getElementById("kecamatan");

      $.ajax({
        type: "POST",
        url: "../pipeline/dist_data_fetch.php",
        data: "id_kec=" + kec.value + "&tahun=" + val +"&bulan=" +bulan.value,
        success: function (data) {
          $("#summon").html(data);
        }
      });
   ...
   var kec = document.getElementById("kecamatan");
      ...
      $.ajax({
        type: "POST",
        url: "../pipeline/dist_data_fetch.php",
        data: "id_kec=" + kec.value + "&tahun=" + tahun.value +"&bulan=" +val,
        success: function (data) {
   ...
   var tahun = document.getElementById("year");
      ...
      $.ajax({
        type: "POST",
        url: "../pipeline/dist_data_fetch.php",
        data: "id_kec=" + val + "&tahun=" + tahun.value +"&bulan=" +bulan.value,
        success: function (data) {
