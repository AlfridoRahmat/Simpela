        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="provinsi_data.php" class="nav-link active">
        ...
        <div class="row mb-1">
          <div class="col-auto">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Penyaluran Provinsi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
function getBulan(val){
 ...
 $.ajax({
 type: "POST",
 url: "../pipeline/set_table_prov.php",
 data : "bulan="+ val +"&tahun="+ tahun.value,
...
function getTahun(val){
 ...
 type: "POST",
 url: "../pipeline/set_table_prov.php",
 data : "bulan="+ bulan.value +"&tahun="+ val,
 success: function(data){
...
function exportTableToExcel(tableID, filename = ''){
    ...
    // Specify file name
    filename = filename?filename +'.xls': 'Provinsi '+ bulan.value +' '+ tahun.value  +'.xls';
