        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="kabupaten_data.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kabupaten</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-1">
          <div class="col-auto">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Penyaluran Kabupaten</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
            ...
            <div class="card">
              <div class="card-header">
                 ...
                 <label> Kabupaten : </label>
                  <select  id="provinsi" onchange="getId(this.value);">
                  <option disabled selected> Daftar Kabupaten </option>
      ...
      ?>	
                ...
                <label>Bulan : </label>
          <select class="" id="bulan" onchange="getBulan(this.value);">
...
<script>
 ...
 type: "POST",
 url: "../pipeline/set_table_kecamatan.php",
...
function exportTableToExcel(tableID, filename = ''){
    ...
    // Specify file name
    filename = filename?filename +'.xls': nama_prov.text +' '+ bulan.value +' '+ tahun.value  +'.xls';
